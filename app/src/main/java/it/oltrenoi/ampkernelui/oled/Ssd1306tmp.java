...
public class Ssd1306tmp implements Closeable {

    private static final String TAG = Ssd1306tmp.class.getSimpleName();
    ...
    public Ssd1306tmp(String i2DeviceName) throws IOException {
